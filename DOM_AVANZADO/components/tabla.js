...
// import cards from "./cards.js";
// const tabla=(()=>{
//     const cuerpoTabla=document.getElementById('taskTable').getElementsByTagName('tbody')[0];//primero recuperamos todo lo que tenemos en la tabla, luego entramos al body
...
//     };
// //recuperamos elementos (texto) de la tabla
// const getTask=()=>{
//     return Array.from(cuerpoTabla.rows).map(row=>({
//     task:row.cells[0].textContent,
//     description:row.cells[1].textContent,
